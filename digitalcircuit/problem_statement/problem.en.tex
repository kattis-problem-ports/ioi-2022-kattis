...
\end{itemize}
and prints the $Q$ return values of \texttt{count\_ways}, one per line.

The sample interaction below shows the same data as the judge sends it: lines the judge sends to your
program and the answers your program sends back, in the order they are exchanged.
